...
V90 introduces components/update/update list.txt as a simple manifest. The updater
...
def download_remote_manifest(timeout=25):
    try:
        text = _download_text(f"components/update/{UPDATE_LIST_NAME}", timeout=timeout)
    except Exception:
