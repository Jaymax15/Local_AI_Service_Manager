...
def _project_root_windows():
    ...
    candidates = []
    try:
        candidates.append(paths.PROJECT_ROOT)
    except Exception:
        pass
    try:
        import sys
...
def ensure_base_install_folders(log_func=None):
    ...
    It also creates the portable Ollama model folder. Installed detection no
    longer treats a bare ollama folder as an installed service.
    """
